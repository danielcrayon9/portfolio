...
var m=window.innerWidth<=1000&&vl?vl.offsetHeight+vh*0.08:vh*0.4;
...
var bias=window.innerWidth<=1000&&vl?Math.min(vh*0.42,Math.max(72,vl.getBoundingClientRect().bottom+vh*0.06)):vh*0.22;
